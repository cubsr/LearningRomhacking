...
// Fully-specified gift mon for the givemon script command. 0xFF for
// nature/ability/gender/EVs/IVs means "use the default/random value".
u8 ScriptGiveMonFull(u16 species, u8 level, u16 item, u16 ball, u8 nature, u8 abilityNum, u8 gender,
                 ...
                 u16 move1, u16 move2, u16 move3, u16 move4, bool8 isShiny, bool8 gmaxFactor, u8 teraType, u8 dmaxLevel)
{
    ...
    return ScriptGiveMonParameterized(0, PARTY_SIZE, species, level, item, ball, nature, abilityNum, gender,
...
void ScrCmd_createmon(struct ScriptContext *ctx)
{
    ...
    // Scripted gift/static mons given to the player are randomized like other static encounters.
    if (side == 0 && IsRandomizationEnabled(RANDOMIZATION_STATIC))
    {
